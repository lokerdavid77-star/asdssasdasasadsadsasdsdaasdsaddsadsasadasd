...
-- vozoid hax - rivals
-- =================================================================
local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/lokerdavid77-star/asdssasdasasadsadsasdsdaasdsaddsadsasadasd/refs/heads/main/vozoidui.lua"))()
...
light:Slider({ Name = "Time of Day", Flag = "TimeOfDay",
    Min = 0, Max = 24, Default = 12, Decimals = 
