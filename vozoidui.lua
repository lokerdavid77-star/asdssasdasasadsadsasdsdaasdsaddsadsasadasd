...
function Library:Window(cfg)
    ...
    function win:Tab(name)
        ...
        function tab:Section(sectionName, side)
            ...
            ---------------------------------------------------------
            -- TOGGLE  (click surface: whole row, top ZIndex)
            ---------------------------------------------------------
            function sec:Toggle(o)
                ...
                -- optional color swatch (its own click handler)
                local swatch
                if o.Color then
                ...
                -- click surface: covers the whole row, above everything
            ...
            function sec:Input(o)
                ...
                local item = {
                    Name = o.Name, Flag = flag, Value = value,
                    Set = function(_, v)
                        value = v; Library.Flags[flag] = v; box.Text = tostring(v)
                    end,
                }
                Library.Items[flag] = item
                box.FocusLost:Connect(function()
            ...
            function sec:Keybind(o)
                ...
                local item = {
                    ...
                    Set = function(_, v)
                        key = v; Library.Flags[flag] = v; btn.Text = v.Name
                    end,
                }
                Library.Items[flag] = item
